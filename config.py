...
STAGE2_DEBUG_AUX_ALIGNMENT = True
...
STAGE2_PHASE_A_TF_END = 1.0

# Phase A2 (context encoder enabled, decoder still frozen)
STAGE2_PHASE_A2_EPOCHS = 3
STAGE2_PHASE_A2_LAMBDA_BOX = 0.5
STAGE2_PHASE_A2_LAMBDA_DELTA = 1.0
STAGE2_PHASE_A2_LAMBDA_SCORE = 0.3
STAGE2_PHASE_A2_LAMBDA_AUX = 1.0
STAGE2_PHASE_A2_LAMBDA_DECODER = 0.0
STAGE2_PHASE_A2_TF_START = 1.0
STAGE2_PHASE_A2_TF_END = 0.974432737452076

# Phase B
STAGE2_PHASE_B_EPOCHS = 10
STAGE2_PHASE_B_LAMBDA_BOX = 0.5
STAGE2_PHASE_B_LAMBDA_DELTA = 1.0
STAGE2_PHASE_B_LAMBDA_SCORE = 0.3
STAGE2_PHASE_B_LAMBDA_AUX = 0.2
STAGE2_PHASE_B_LAMBDA_DECODER = 1.0
STAGE2_PHASE_B_TF_START = 1.0
STAGE2_PHASE_B_TF_END = 0.8