...
def objective(trial: optuna.Trial, args: argparse.Namespace) -> float:
    ...
    try:
        ...
        # train_stage2_hybrid's own model/optimizer/dataloaders already went
        # out of scope when it returned; this still reclaims whatever became
        # garbage during that call (e.g. autograd-graph reference cycles that
        # plain refcounting misses) before the next trial builds a new model.
        release_cuda_memory()
